    ...
    async run(em) {
        await em.insertMany(Feedback, [
            ...
            },
            {
                ...
                content: "It would be great to see a more detailed breakdown of solutions.",
                author: em.getReference(User, 7),
                category: em.getReference(Category, 5),
            },
            {
                title: "Learning paths",
                content: "Sequenced projects for different goals to help people improve.",
                author: em.getReference(User, 8),
                category: em.getReference(Category, 5),
            },
            {
                title: "One-click portfolio generation",
                content: "Add ability to create professional looking portfolio from profile.",
            ...
            },
            {
                ...
                content: "Screenshots of solutions with animations don’t display correctly.",
